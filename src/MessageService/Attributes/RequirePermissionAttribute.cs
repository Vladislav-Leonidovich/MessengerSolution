...
namespace MessageService.Attributes
{
    ...
    {
        public RequirePermissionAttribute(MessagePermission permission)
        ...
        {
            private readonly MessagePermission _permission;
            private readonly IPermissionService<MessagePermission> _permissionService;
            private readonly ILogger<RequirePermissionFilter> _logger;

            public RequirePermissionFilter(
                MessagePermission permission,
                IPermissionService<MessagePermission> permissionService,
            ...
            private int? TryGetResourceId(ActionExecutingContext context)
            {
                ...
                var possibleIds = new[] { "id", "chatId", "chatRoomId", "messageId" };
